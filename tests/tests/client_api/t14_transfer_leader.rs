...
///
/// Call [`handle_transfer_leader`](suraft::raft::Raft::handle_transfer_leader) on every
...
///
/// Call [`trigger().transfer_leader()`](suraft::raft::trigger::Trigger::transfer_leader) on the

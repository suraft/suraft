    ...
    C: TypeConfig,
{
    ...
    async fn write(&mut self, path: &str, buf: &[u8], exclusive: bool) -> Result<bool, io::Error>;

    async fn list(&mut self, prefix: &str, start_after: &str) -> Result<Vec<String>, io::Error>;
}
